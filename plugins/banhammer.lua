...
do
  ...
  return {
    ...
    usage = {
      user = {
        "!kme : Kick yourself out of this group."
      },
      admin = {
      ...
      moderator = {
        "!an k : Enable flood protection. Flooder will be kicked.",
        "!an b : Enable flood protection. Flooder will be banned.",
        ...
        "!k <user_id>/<@username>: Kick user from chat group",
